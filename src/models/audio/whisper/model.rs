...
impl WhichModel {
    pub(crate) fn get_model_string(&self) -> String {
        match self {
            Self::Tiny => "tiny".to_string(),
            Self::TinyEn => "tiny.en".to_string(),
            Self::Base => "base".to_string(),
            Self::BaseEn => "base.en".to_string(),
            Self::Small => "small".to_string(),
            Self::SmallEn => "small.en".to_string(),
            Self::Medium => "medium".to_string(),
            Self::MediumEn => "medium.en".to_string(),
            Self::Large => "large".to_string(),
            Self::LargeV2 => "large-v2".to_string(),
            Self::LargeV3 => "large-v3".to_string(),
            Self::DistilMediumEn => "distil-medium.en".to_string(),
            Self::DistilLargeV2 => "distil-large-v2".to_string(),
        }
    }
